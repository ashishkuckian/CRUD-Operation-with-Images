...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
  ...
  <div class="card p-4 shadow-lg" style="width: 24rem;">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><strong>Phone:</strong> <?php echo htmlspecialchars($user["phone"] ?? 'N/A'); ?></li> <!-- Added phone -->
      <li class="list-group-item"><strong>Address:</strong> <?php echo htmlspecialchars($user["address"] ?? 'N/A'); ?></li> <!-- Added address -->
      <li class="list-group-item"><strong>Subscribed:</strong> <?php echo $user["newsletter_subscription"] ? 'Yes' : 'No'; ?></li> <!-- Added subscription status -->
